...
public class FareEstimateActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void findRoute(String destLocLatitude, String destLocLongitude) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/json?origin=" + originLoc + "&destination=" + destLoc + "&sensor=true&key=" + serverKey + "&language=" + generalFunc.retrieveValue(Utils.GOOGLE_MAP_LANGUAGE_CODE_KEY);
