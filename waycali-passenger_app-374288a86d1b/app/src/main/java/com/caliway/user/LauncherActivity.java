...
//        checkConfigurations(true);
    ...
    public void downloadGeneralData() {
        ...
        parameters.put("AppVersion", new AppFunctions(getActContext()).getAppVersion());
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        generalFunc.storeData(Utils.FACEBOOK_APPID_KEY, generalFunc.getJsonValue("FACEBOOK_APP_ID", responseString));
                        generalFunc.storeData(Utils.LINK_FORGET_PASS_KEY, generalFunc.getJsonValue("LINK_FORGET_PASS_PAGE_PASSENGER", responseString));
                        generalFunc.storeData(Utils.APP_GCM_SENDER_ID_KEY, generalFunc.getJsonValue("GOOGLE_SENDER_ID", responseString));
                        generalFunc.storeData(Utils.MOBILE_VERIFICATION_ENABLE_KEY, generalFunc.getJsonValue("MOBILE_VERIFICATION_ENABLE", responseString));

                        generalFunc.storeData(Utils.CURRENCY_LIST_KEY, generalFunc.getJsonValue("LIST_CURRENCY", responseString));


                        generalFunc.storeData(Utils.GOOGLE_MAP_LANGUAGE_CODE_KEY, generalFunc.getJsonValue("vGMapLangCode", generalFunc.getJsonValue("DefaultLanguageValues", responseString)));
                        generalFunc.storeData(Utils.REFERRAL_SCHEME_ENABLE, generalFunc.getJsonValue("REFERRAL_SCHEME_ENABLE", responseString));
                        generalFunc.storeData(Utils.SITE_TYPE_KEY, generalFunc.getJsonValue("SITE_TYPE", responseString));


                        //  if (generalFunc.retrieveValue(Utils.LANGUAGE_CODE_KEY).equalsIgnoreCase("")) {
                        generalFunc.storeData(Utils.languageLabelsKey, generalFunc.getJsonValue("LanguageLabels", responseString));
                        generalFunc.storeData(Utils.LANGUAGE_LIST_KEY, generalFunc.getJsonValue("LIST_LANGUAGES", responseString));
                        generalFunc.storeData(Utils.LANGUAGE_IS_RTL_KEY, generalFunc.getJsonValue("eType", generalFunc.getJsonValue("DefaultLanguageValues", responseString)));
                        generalFunc.storeData(Utils.LANGUAGE_CODE_KEY, generalFunc.getJsonValue("vCode", generalFunc.getJsonValue("DefaultLanguageValues", responseString)));
                        generalFunc.storeData(Utils.DEFAULT_LANGUAGE_VALUE, generalFunc.getJsonValue("vTitle", generalFunc.getJsonValue("DefaultLanguageValues", responseString)));
                        //  }

                        if (generalFunc.retrieveValue(Utils.DEFAULT_CURRENCY_VALUE).equalsIgnoreCase("")) {
                            generalFunc.storeData(Utils.DEFAULT_CURRENCY_VALUE, generalFunc.getJsonValue("vName", generalFunc.getJsonValue("DefaultCurrencyValues", responseString)));
                        }

                        generalFunc.storeData(Utils.FACEBOOK_LOGIN, generalFunc.getJsonValue("FACEBOOK_LOGIN", responseString));
                        generalFunc.storeData(Utils.GOOGLE_LOGIN, generalFunc.getJsonValue("GOOGLE_LOGIN", responseString));
                        generalFunc.storeData(Utils.TWITTER_LOGIN, generalFunc.getJsonValue("TWITTER_LOGIN", responseString));

                        generalFunc.storeData(Utils.DefaultCountry, generalFunc.getJsonValue("vDefaultCountry", responseString));
                        generalFunc.storeData(Utils.DefaultCountryCode, generalFunc.getJsonValue("vDefaultCountryCode", responseString));
                        generalFunc.storeData(Utils.DefaultPhoneCode, generalFunc.getJsonValue("vDefaultPhoneCode", responseString));
                        Utils.setAppLocal(getActContext());
                        closeLoader();
